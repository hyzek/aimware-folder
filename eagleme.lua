...
local auto_hitchance = "rbot.accuracy.weapon.asniper.hitchance"
--end
...
custom_scope_overlay_cb = gui.Checkbox(gui.Reference("Settings","EagleHook","Visuals"), "cscope", "Custom Scope Overlay", false)
scope_color = gui.ColorPicker(gui.Reference("Settings","EagleHook","Visuals"), "cpicker", "Overlay Color", 150, 200, 60, 255)
color_picker_size = gui.Slider(gui.Reference("Settings","EagleHook","Visuals"), "cslider", "Overlay Size", 100, 50, 800, 10)
-- Visuals end
...
inverter_key = gui.Keybox(gui.Reference("Settings","EagleHook","Misc"), "inverter_key", "LBY Inverter", "");
noscope_hitchance_cb = gui.Checkbox(gui.Reference("Settings","EagleHook","Misc"), "noscope_hitchance_toggle", "Noscope Hitchance", false);
scoped_hitchance = gui.Slider(gui.Reference("Settings","EagleHook","Misc"),"scoped_hitchance", "Scoped hitchance", gui.GetValue(auto_hitchance), 0, 100);
noscope_hitchance = gui.Slider(gui.Reference("Settings","EagleHook","Misc"),"no_scoped_hitchance", "Noscope hitchance", gui.GetValue(auto_hitchance) - 30, 0, 100);
--server_crasher_cb = gui.Checkbox(gui.Reference("Settings","EagleHook","Misc"),"server_crasher", "Server crasher", false);
-- Misc end
